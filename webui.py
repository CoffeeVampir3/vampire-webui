...
prompt_textbox = gr.Textbox(lines=3, placeholder="Promp here")
negative_prompt_textbox = gr.Textbox(lines=3, laceholder="Negatives here")
...
width_slider = gr.Slider(minimum=256, maximum=2048,value=1,step=32)
height_slider = gr.Slider(minimum=256, maximum=2048,value=1,step=32)
num_steps_slider = gr.Slider(minimum=1, maximum=250,value=1,step=1)
cfg_slider = gr.Slider(minimum=1, maximum=50,value=1,step=0.5)
